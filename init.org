...
#+begin_src emacs-lisp
(leaf fuz
  :straight '(fuz :type git :host github :repo "cireu/fuz.el"
                  :files ("*" (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el" "*-tests.el")))
  :require t
  :config
...
(leaf ox-pygmentize-html
  ...
  :custom ((org-html-html5-fancy . t)
           ...
           (ox-pygments-option . "style=solarized-light,linenos=table,wrapcode")))
#+end_src
